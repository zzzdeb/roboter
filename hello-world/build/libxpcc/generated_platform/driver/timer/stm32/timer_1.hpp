...
*/
// ----------------------------------------------------------------------------
#ifndef XPCC_STM32_TIMER_1_HPP
#define XPCC_STM32_TIMER_1_HPP
...
public:
	...
	setPeriod(uint32_t microseconds, bool autoApply = true)
	{
		...
		// unequal to zero)
		uint32_t cycles = microseconds * (SystemClock::Timer1 / 1000000UL);
