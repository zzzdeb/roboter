...
// ----------------------------------------------------------------------------
void
xpcc::stm32::Timer12::clockEnable()
{
	// enable clock
...
// ----------------------------------------------------------------------------
void
xpcc::stm32::Timer12::setMode(Mode mode, SlaveMode slaveMode,
		...
		bool enableOnePulseMode)
{
	...
	if (enableOnePulseMode) {
		TIM12->CR1 = TIM_CR1_ARPE | TIM_CR1_URS | TIM_CR1_OPM
...
// ----------------------------------------------------------------------------
void
xpcc::stm32::Timer12::configureInputChannel(uint32_t channel,
...
// ----------------------------------------------------------------------------
void
xpcc::stm32::Timer12::configureOutputChannel(uint32_t channel,
...
// ----------------------------------------------------------------------------
void
xpcc::stm32::Timer12::enableInterruptVector(bool enable, uint32_t priority)
{
	if (enable) {
