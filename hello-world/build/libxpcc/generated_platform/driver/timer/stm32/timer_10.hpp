...
#ifndef XPCC_STM32_TIMER_10_HPP
#define XPCC_STM32_TIMER_10_HPP
...
public:
	...
	static const TypeId::Timer10Channel1 Channel1;
public:
	...
	setPeriod(uint32_t microseconds, bool autoApply = true)
	{
		...
		// unequal to zero)
		uint32_t cycles = microseconds * (SystemClock::Timer10 / 1000000UL);
...
public:
	...
	getInterruptFlags()
	{
		return InterruptFlag_t(TIM10->SR);
	}
