 ...
 */
// ----------------------------------------------------------------------------
#ifndef XPCC_STM32_UART_4_HPP
#define XPCC_STM32_UART_4_HPP
...
template< 	class SystemClock, uint32_t baudrate,
	...
	initialize(uint32_t interruptPriority, Parity parity = Parity::Disabled)
	{
		...
		UartHal4::initializeWithBrr(
				UartBaudrate::getBrr<SystemClock::Uart4, baudrate, tolerance>(),
				parity,
				oversample);
		initializeBuffered(interruptPriority);
		UartHal4::setTransmitterEnable(true);
		UartHal4::setReceiverEnable(true);
	}
