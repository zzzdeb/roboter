...
#ifndef XPCC_STM32_UART_SPI_MASTER6_HPP
#define XPCC_STM32_UART_SPI_MASTER6_HPP

#include <xpcc/architecture/interface/spi_master.hpp>
#include "../../uart/stm32/uart_hal_6.hpp"
 ...
 */
class UartSpiMaster6 : public xpcc::SpiMaster, public UartBase
{
...
public:
	static const TypeId::UartSpiMaster6Sck  Sck;
	static const TypeId::UartSpiMaster6Miso Miso;
	static const TypeId::UartSpiMaster6Mosi Mosi;
...
public:
	...
	initialize()
	{
		...
		UsartHal6::initializeWithBrr(
				...
				UsartHal6::Parity::Disabled,
				oversample);
		UsartHal6::setLastBitClockPulse(UsartHal6::LastBitClockPulse::Output);
		UsartHal6::setSpiClock(UsartHal6::SpiClock::Enabled);
	...
	{
		UsartHal6::setSpiDataMode(static_cast<UartBase::SpiDataMode>(mode));
	}
...
#endif // XPCC_STM32_UART_SPI_MASTER6_HPP