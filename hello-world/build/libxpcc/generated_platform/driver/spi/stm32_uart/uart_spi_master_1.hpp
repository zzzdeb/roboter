...
#ifndef XPCC_STM32_UART_SPI_MASTER1_HPP
#define XPCC_STM32_UART_SPI_MASTER1_HPP

#include <xpcc/architecture/interface/spi_master.hpp>
#include "../../uart/stm32/uart_hal_1.hpp"
 ...
 */
class UartSpiMaster1 : public xpcc::SpiMaster, public UartBase
{
...
public:
	static const TypeId::UartSpiMaster1Sck  Sck;
	static const TypeId::UartSpiMaster1Miso Miso;
	static const TypeId::UartSpiMaster1Mosi Mosi;
...
public:
	...
	initialize()
	{
		...
		UsartHal1::initializeWithBrr(
				...
				UsartHal1::Parity::Disabled,
				oversample);
		UsartHal1::setLastBitClockPulse(UsartHal1::LastBitClockPulse::Output);
		UsartHal1::setSpiClock(UsartHal1::SpiClock::Enabled);
	...
	{
		UsartHal1::setSpiDataMode(static_cast<UartBase::SpiDataMode>(mode));
	}
...
#endif // XPCC_STM32_UART_SPI_MASTER1_HPP