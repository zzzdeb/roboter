...
#ifndef XPCC_STM32_UART_SPI_MASTER3_HPP
#define XPCC_STM32_UART_SPI_MASTER3_HPP

#include <xpcc/architecture/interface/spi_master.hpp>
#include "../../uart/stm32/uart_hal_3.hpp"
 ...
 */
class UartSpiMaster3 : public xpcc::SpiMaster, public UartBase
{
...
public:
	static const TypeId::UartSpiMaster3Sck  Sck;
	static const TypeId::UartSpiMaster3Miso Miso;
	static const TypeId::UartSpiMaster3Mosi Mosi;
...
public:
	...
	initialize()
	{
		...
		UsartHal3::initializeWithBrr(
				...
				UsartHal3::Parity::Disabled,
				oversample);
		UsartHal3::setLastBitClockPulse(UsartHal3::LastBitClockPulse::Output);
...
#endif // XPCC_STM32_UART_SPI_MASTER3_HPP