...
#include "uart_spi_master_1.hpp"
#include <xpcc/math/utils/bit_operation.hpp>
#include <xpcc/architecture/interface/register.hpp>

xpcc::stm32::UartSpiMaster1::DataOrder
	xpcc::stm32::UartSpiMaster1::dataOrder =
	xpcc::stm32::UartSpiMaster1::DataOrder::MsbFirst;

// Bit0: single transfer state
// Bit1: block transfer state
uint8_t
xpcc::stm32::UartSpiMaster1::state(0);

uint8_t
xpcc::stm32::UartSpiMaster1::count(0);

void *
xpcc::stm32::UartSpiMaster1::context(nullptr);

xpcc::Spi::ConfigurationHandler
xpcc::stm32::UartSpiMaster1::configuration(nullptr);
// ----------------------------------------------------------------------------

uint8_t
xpcc::stm32::UartSpiMaster1::acquire(void *ctx, ConfigurationHandler handler)
{
	if (context == nullptr)
	{
		context = ctx;
...
uint8_t
xpcc::stm32::UartSpiMaster1::release(void *ctx)
{
	if (ctx == context)
	{
		if (--count == 0)
...
xpcc::stm32::UartSpiMaster1::transfer(uint8_t data)
{
...
xpcc::stm32::UartSpiMaster1::transfer(
