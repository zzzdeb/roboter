...
xpcc::stm32::UartSpiMaster3::DataOrder
	xpcc::stm32::UartSpiMaster3::dataOrder =
	xpcc::stm32::UartSpiMaster3::DataOrder::MsbFirst;

// Bit0: single transfer state
// Bit1: block transfer state
uint8_t
xpcc::stm32::UartSpiMaster3::state(0);

uint8_t
xpcc::stm32::UartSpiMaster3::count(0);

void *
xpcc::stm32::UartSpiMaster3::context(nullptr);

xpcc::Spi::ConfigurationHandler
xpcc::stm32::UartSpiMaster3::configuration(nullptr);
// ----------------------------------------------------------------------------

uint8_t
xpcc::stm32::UartSpiMaster3::acquire(void *ctx, ConfigurationHandler handler)
{
	if (context == nullptr)
	{
		context = ctx;
...
uint8_t
xpcc::stm32::UartSpiMaster3::release(void *ctx)
{
	if (ctx == context)
	{
		if (--count == 0)
...
xpcc::stm32::UartSpiMaster3::transfer(uint8_t data)
{
...
xpcc::stm32::UartSpiMaster3::transfer(
