...
uint8_t
xpcc::stm32::SpiMaster1::state(0);

uint8_t
xpcc::stm32::SpiMaster1::count(0);

void *
xpcc::stm32::SpiMaster1::context(nullptr);

xpcc::Spi::ConfigurationHandler
xpcc::stm32::SpiMaster1::configuration(nullptr);
// ----------------------------------------------------------------------------

uint8_t
xpcc::stm32::SpiMaster1::acquire(void *ctx, ConfigurationHandler handler)
{
	if (context == nullptr)
	{
		context = ctx;
...
uint8_t
xpcc::stm32::SpiMaster1::release(void *ctx)
{
	if (ctx == context)
	{
		if (--count == 0)
...
xpcc::stm32::SpiMaster1::transfer(uint8_t data)
{
...
xpcc::stm32::SpiMaster1::transfer(
