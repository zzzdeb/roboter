...
#ifndef XPCC_STM32_I2C_1_HPP
#define XPCC_STM32_I2C_1_HPP
 ...
 */
class I2cMaster1 : public ::xpcc::I2cMaster
{
public:
	static const TypeId::I2cMaster1Sda Sda;
	static const TypeId::I2cMaster1Scl Scl;
...
public:
	...
	initialize()
	{
		...
		constexpr float pre_raw  = float(SystemClock::I2c1) / (scalar * baudrate);
		...
		constexpr uint32_t baud_lower = SystemClock::I2c1 / ( scalar * pre_ceil  );
		constexpr uint32_t baud_upper = SystemClock::I2c1 / ( scalar * pre_floor );
		...
		constexpr uint32_t generated_baudrate = SystemClock::I2c1 / ( scalar * pre );
		...
		constexpr uint8_t freq = SystemClock::I2c1 / 1000000;
