...
namespace
{
	...
	callStarting()
	{
		...
		if ((I2C1->SR2 & I2C_SR2_BUSY) and (nextOperation != xpcc::I2c::Operation::Restart))
		{
...
void
xpcc::stm32::I2cMaster1::initializeWithPrescaler(uint8_t peripheralFrequency, uint8_t riseTime, uint16_t prescaler)
{
...
// MARK: - ownership
bool
xpcc::stm32::I2cMaster1::start(I2cTransaction *transaction, ConfigurationHandler handler)
{
	xpcc::atomic::Lock lock;
