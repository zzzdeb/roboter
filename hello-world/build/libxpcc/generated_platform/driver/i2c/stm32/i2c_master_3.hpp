...
#ifndef XPCC_STM32_I2C_3_HPP
#define XPCC_STM32_I2C_3_HPP
 ...
 */
class I2cMaster3 : public ::xpcc::I2cMaster
{
public:
	static const TypeId::I2cMaster3Sda Sda;
	static const TypeId::I2cMaster3Scl Scl;
...
public:
	...
	initialize()
	{
		...
		constexpr float pre_raw  = float(SystemClock::I2c3) / (scalar * baudrate);
		...
		constexpr uint32_t baud_lower = SystemClock::I2c3 / ( scalar * pre_ceil  );
		constexpr uint32_t baud_upper = SystemClock::I2c3 / ( scalar * pre_floor );
		...
		constexpr uint32_t generated_baudrate = SystemClock::I2c3 / ( scalar * pre );
		...
		constexpr uint8_t freq = SystemClock::I2c3 / 1000000;
